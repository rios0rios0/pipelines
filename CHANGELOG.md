...
- changed search location of folder generated by cypress in job `test:e2e`
...
- fixed path to `fetch_token_helpers` file in `test_e2e` job
- fixed path to `token_helpers.ts` file in `test_e2e` job
