# GitHub Actions -- .NET with Docker Example

Minimal example showing how to use the reusable .NET/C# + Docker workflow from `rios0rios0/pipelines`.

## Files

| File | Purpose |
|------|---------|
| `.github/workflows/ci.yaml` | Calls the reusable `dotnet-docker.yaml` workflow |
