# GitHub Actions -- JavaScript with Docker Example

Minimal example showing how to use the reusable JavaScript/Yarn + Docker workflow from `rios0rios0/pipelines`.

## Files

| File | Purpose |
|------|---------|
| `.github/workflows/ci.yaml` | Calls the reusable `javascript-docker.yaml` workflow |
